...
`Spring Boot` `Spring MVC` `Spring Data JPA` `Spring Security` `Hibernate` `Lombok`

**Databases**
`MySQL` `PostgreSQL` `H2`

**Tools & DevOps**
`Maven` `Git & GitHub` `Postman` `IntelliJ IDEA` `Docker` `GitHub Actions` `AWS (EC2, S3, RDS)`
...
|---|---|---|
| [Banking Application System](https://github.com/CGaganGowda/Banking-Application-System) | Spring Boot, JPA, MySQL | Account CRUD, fund transfers, transaction history, exception handling |
| [Employee Management System](https://github.com/CGaganGowda/Employee-Management-System) | Spring Boot, JPA, Maven | Full CRUD, layered architecture, 100+ commits |

---

## 📚 Currently learning

 `Spring Cloud` `Redis caching` `Kafka`
